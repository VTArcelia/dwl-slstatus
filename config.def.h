...
static const char *fonts[]                 = {"DepartureMono Nerd Font Mono:style=Bold:size=14"};
...
static const char *kanshi_restart[] = { "/bin/sh", "-c", "pkill kanshi; kanshi & wlr-randr --output DP-2 --adaptive-sync enabled", NULL };
